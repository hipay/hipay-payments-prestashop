...
class HiPayPaymentsNotifyModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $logger->debug('Notification received for transaction reference '.(isset($transactionArray['transaction_reference']) ? $transactionArray['transaction_reference'] : 'unknown'), ['data' => $transactionArray, 'validSignature' => $isValidSignature]);

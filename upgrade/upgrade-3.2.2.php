 ...
 * @return bool
 */
function upgrade_module_3_2_2(HiPayPayments $module): bool
{
    $dbQuery = (new DbQuery)
    ...
    $installer->getLogger()->info('Start of Upgrade module to 3.2.2');
    ...
    $installer->getLogger()->info('End of Upgrade module to 3.2.2');

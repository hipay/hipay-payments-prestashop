...
class AdminTransactionPresenter implements PresenterInterface
{
    ...
    public function present($object, int $idShop = null): array
    {
        ...
        $capturableAmount = AmountOfMoney::subtract($authorizedAmount, $capturedAmount, $object->getCurrency());
        ...
        if ($paymentMethod && true === $paymentMethod->canRefund) {
            $refundableAmount = AmountOfMoney::subtract($capturedAmount, $refundedAmount, $object->getCurrency());

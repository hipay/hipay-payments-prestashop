...
/**
 * Class OtherPMSettingsValidation
 */
class OtherPMSettingsValidation extends AbstractValidationData
{
    /**
     * @param mixed[] $array
     * @return mixed[]
                ...
                'constraints' => [
                    ...
                    new Assert\Callback(function ($item, ExecutionContextInterface $context) {
                        ...
                        if (
                            ...
                            $context->buildViolation(sprintf($this->module->l('The maximum amount must be greater than minimum amount for payment method %s', 'OtherPMSettingsValidation'), $item['name']))
                                ->atPath('[minAmount]')
                                ->addViolation();
                        }
                    }),

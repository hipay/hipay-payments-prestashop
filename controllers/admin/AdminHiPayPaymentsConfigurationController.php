...
class AdminHiPayPaymentsConfigurationController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->tabs = [
            self::TAB_INTRO => [
                'active' => false,
                'title' => $this->module->l('Intro', 'AdminHiPayPaymentsConfigurationController'),
                'filename' => './_intro.tpl',
            ],
            self::TAB_ACCOUNT => [
                'active' => false,
                'title' => $this->module->l('My account', 'AdminHiPayPaymentsConfigurationController'),
                'filename' => './_accountSettings.tpl',
                'icon' => 'icon-user',
            ],
            self::TAB_MAIN_SETTINGS => [
                'active' => false,
                'title' => $this->module->l('Main settings', 'AdminHiPayPaymentsConfigurationController'),
                'filename' => './_mainSettings.tpl',
                'icon' => 'icon-cogs',
            ],
            self::TAB_CARD_SETTINGS => [
                'active' => false,
                'title' => $this->module->l('Card payment', 'AdminHiPayPaymentsConfigurationController'),
                'filename' => './_cardPaymentSettings.tpl',
                'icon' => 'icon-credit-card',
            ],
            self::TAB_OTHER_PM => [
                'active' => false,
                'title' => $this->module->l('Other payment methods', 'AdminHiPayPaymentsConfigurationController'),

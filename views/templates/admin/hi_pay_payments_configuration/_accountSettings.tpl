        ...
        <div class="row">
            <div class="col-xs-12">
                {foreach $data.accountSettings.hashingAlgorithms as $key => $hashingAlgorithm}
                    <input type="hidden" name="hpAccountSettings[hashingAlgorithms][{$key|escape:'html':'UTF-8'}]"
                           value="{$hashingAlgorithm|escape:'htmlall':'UTF-8'}"/>
                {/foreach}
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"
                                           name="hpAccountSettings[applePayTestPrivateIdentifiers][username]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[applePayTestPrivateIdentifiers][password]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[applePayTestPrivateIdentifiers][secret]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[motoTestPrivateIdentifiers][password]"
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[applePayTestPublicIdentifiers][password]"
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"
                                           name="hpAccountSettings[applePayProdPrivateIdentifiers][username]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[applePayProdPrivateIdentifiers][password]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[motoProdPrivateIdentifiers][password]"
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="password"
                                           name="hpAccountSettings[applePayProdPublicIdentifiers][password]"
